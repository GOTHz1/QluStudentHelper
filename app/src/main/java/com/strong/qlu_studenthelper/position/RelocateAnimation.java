package com.strong.qlu_studenthelper.position;
...
public class RelocateAnimation extends Thread{
    ...
    public void run() {
        ...
        lat2 = LocationMainActivity.locationMainActivity.locationSetter.getLocation().getLatitude() ;
        lng2 = LocationMainActivity.locationMainActivity.locationSetter.getLocation().getLongitude() ;
        rot2 = LocationMainActivity.locationMainActivity.locationSetter.getmXDirection();
        ...
        MyLocationData locData = new MyLocationData.Builder().accuracy(50)
                ...
                .direction(LocationMainActivity.locationMainActivity.locationSetter.getmXDirection())
                .latitude(lat)
                .longitude(lng).build();
        // 设置定位数据
