package com.strong.qlu_studenthelper.location.imageProcessing;
...
public class ImageProcessing {
    ...
    public static Bitmap ChangBitmapSize(Bitmap bitmap){
        ...
        //放大為屏幕的1/2大小
        float screenWidth  = LocationMainActivity.locationMainActivity.getWindowManager().getDefaultDisplay().getWidth();		// 屏幕宽（像素，如：480px）
        float screenHeight = LocationMainActivity.locationMainActivity.getWindowManager().getDefaultDisplay().getHeight();		// 屏幕高（像素，如：800p）
